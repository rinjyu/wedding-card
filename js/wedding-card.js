...
$(document).ready(function(){
    ...
    $("#wedding-main-img").fadeOut(3000, function () {
        $(this).attr("src", "assets/img/wedding/wedding-main.png");
        $(this).fadeIn(3000);
    });
...
let calculatorWeddingDay = function() {
    ...
    if (day > 0) {
        ...
        ddayText = ddayText + "이 <span style=\"color:red\"><strong>" + day + "</strong></span>일 지났습니다.";
    }
...
let contact = function(target, method) {
    if (target === "groomFather") {
        location.href=method + ":01025356137";
    } else if (target === "groomMother") {
        location.href=method + ":01026988138";
    } else if (target === "brideFather") {
        location.href=method + ":01091170454";
    } else if (target === "brideMother") {
        location.href=method + ":01099245287";
    } else if (target === "groom") {
        location.href=method + ":01082488548";
    } else {
        location.href=method + ":01056320583";
    }
}